---
id: 43f44420-f362-4635-b02f-5e71171f24ef
title: "folke/which-key.nvim: 💥 Create key bindings that stick. WhichKey is a lua plugin for Neovim 0.5 that displays a popup with possible keybindings of the command you started typing."
tags:
  - nvim
  - text_editors
  - tools_to_use
date: 2024-01-09 23:28:07
words_count: 1655
state: INBOX
---

# folke/which-key.nvim: 💥 Create key bindings that stick. WhichKey is a lua plugin for Neovim 0.5 that displays a popup with possible keybindings of the command you started typing. by 
## Table of contents
```dataviewjs 
...
## description
>[!summary] 
> 💥   Create key bindings that stick. WhichKey is a lua plugin for Neovim 0.5 that displays a popup with possible keybindings of the command you started typing. - folke/which-key.nvim: 💥   Create key...
...
[![image](https://proxy-prod.omnivore-image-cache.app/0x0,s9qg_g1Pudej3s8U1PMj5g0-VIIj7W1H88Lq1RDoHe-8/https://user-images.githubusercontent.com/292349/116439438-669f8d00-a804-11eb-9b5b-c7122bd9acac.png)](https://user-images.githubusercontent.com/292349/116439438-669f8d00-a804-11eb-9b5b-c7122bd9acac.png)
...
> ❗️ IMPORTANT: the [timeout](https://neovim.io/doc/user/options.html#'timeout') when **WhichKey** opens is controlled by the vim setting [timeoutlen](https://neovim.io/doc/user/options.html#'timeoutlen'). Please refer to the documentation to properly set it up. Setting it to `0`, will effectively always show **WhichKey** immediately, but a setting of `500` (500ms) is probably more appropriate.

> ❗️ don't create any keymappings yourself to trigger WhichKey. Unlike with _vim-which-key_, we do this fully automatically. Please remove any left-over triggers you might have from using _vim-which-key_.
...
[![image](https://proxy-prod.omnivore-image-cache.app/0x0,spZbXcfbwyLO2wtZG6Kz05p0QzfLjGAiICBn13HCpYrI/https://user-images.githubusercontent.com/292349/116439573-8f278700-a804-11eb-80ca-bb9263e6d937.png)](https://user-images.githubusercontent.com/292349/116439573-8f278700-a804-11eb-80ca-bb9263e6d937.png)

### Registers

Shows a list of your buffer local and global registers when you hit " in _NORMAL_ mode, or `<c-r>` in _INSERT_ mode.

[![image](https://proxy-prod.omnivore-image-cache.app/0x0,sSFkILyuhyCeay_WvWtajlRJig9tK7nDkEzY4sFSy_8s/https://user-images.githubusercontent.com/292349/116439609-98b0ef00-a804-11eb-9385-97c7d5ff4113.png)](https://user-images.githubusercontent.com/292349/116439609-98b0ef00-a804-11eb-9385-97c7d5ff4113.png)

### Presets

Built-in key binding help for `motions`, `text-objects`, `operators`, `windows`, `nav`, `z` and `g`

[![image](https://proxy-prod.omnivore-image-cache.app/0x0,sv3rXt25DhjFKtnU85dNJbJG3I8fOHPfngjIEgniuqUk/https://user-images.githubusercontent.com/292349/116439871-df9ee480-a804-11eb-9529-800e167db65c.png)](https://user-images.githubusercontent.com/292349/116439871-df9ee480-a804-11eb-9529-800e167db65c.png)
...
[![image](https://proxy-prod.omnivore-image-cache.app/0x0,sqsbt5Kkx4NMdhf23TnQFVpcAxcAFcNmh-0afCy0wMD4/https://user-images.githubusercontent.com/292349/118102022-1c361880-b38d-11eb-8e82-79ad266d9bb8.png)](https://user-images.githubusercontent.com/292349/118102022-1c361880-b38d-11eb-8e82-79ad266d9bb8.png)
...
# links
[Read on Omnivore](https://omnivore.app/me/folke-which-key-nvim-create-key-bindings-that-stick-which-key-is-18cf0202541)
[Read Original](https://github.com/folke/which-key.nvim)

<iframe src="https://github.com/folke/which-key.nvim"  width="800" height="500"></iframe>
