...
## **sub tasks**
 - [ ] write the feature specs down [link](https://todoist.com/showTask?id=7338090645) #todoist %%[todoist_id:: 7338090645]%%
 - [ ] explain the current state [link](https://todoist.com/showTask?id=7338090669) #todoist %%[todoist_id:: 7338090669]%%
...
[GitHub - LucHermitte/vim-refactor: Generic Refactoring Plugin for Vim](https://github.com/LucHermitte/vim-refactor/tree/master)